const JoinSteam = () => {
  return (
    <div className="flex flex-row pt-[48px] items-center mr-auto ml-auto w-[100%] justify-center bg-[#181A21] text-[#E9E9E9] font-serif text-[12px] mb-[-107.5px] font-normal">
        ...
        <img className="flex-1 flex flex-col justify-center items-center max-w-[200px] w-[320px]" src="https://store.cloudflare.steamstatic.com/public/shared/images/login/join_pc.png?v=1"></img>
