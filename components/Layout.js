      ...
      <div className="fixed z-[1000] max-w-[998px] max-h-[762px] left-[50px] top-[134px] block font-sans text-[#c6d4df]">
        <div className={ModalStyles.modal_background}>
          ...
          <div>
            ...
            <img
              className="opacity-100 max-w-[948px] hidden max-h-[688px] cursor-pointer border-0"
              src="https://cdn.cloudflare.steamstatic.com/steam/apps/990080/ss_725bf58485beb4aa37a3a69c1e2baa69bf3e4653.1920x1080.jpg?t=1661535551"
            />
            <img
              className="cursor-pointer hidden"
              src="https://cdn.cloudflare.steamstatic.com/steam/apps/990080/ss_df93b5e8a183f7232d68be94ae78920a90de1443.1920x1080.jpg?t=1661535551"
            />
          </div>
          <div className="relative h-[28px] leading-[28px] mt-[10px] text-center whitespace-nowrap hidden text-ellipsis font-sans text-[12px]">
            <div className="p-0 m-0 leading-[28px] text-center whitespace-nowrap font-sans text-[12px]">
              1 of 5 screenshots
            </div>
            <div className={ModalStyles.modal_btns}>
              <span className="leading-[26px] py-0 px-[15px] text-[15px] rounded-[2px] bg-transparent text-[#67c1f5] cursor-pointer text-center whitespace-nowrap">
                Prev
              </span>
            </div>
            <div className="absolute right-0 top-0 rounded-[2px] border-0 p-[1px] inline-block cursor-pointer decoration-0 text-[#67c1f5] bg-[#67c1f533] leading-[28px] text-center whitespace-nowrap font-sans text-[12px]">
              <span className="py-0 px-[15px] text-[15px] rounded-[2px] bg-transparent cursor-pointer text-[#67c1f5] text-center whitespace-nowrap font-sans">
                Next
              </span>
            </div>
          </div>
